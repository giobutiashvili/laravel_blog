                ...
                <li class="nav-item">
                    ...
                    >
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{url('Admin/blogs')}}"
                                >Blogs</a
                            >
                            <a class="collapse-item" href="{{url('Admin/aboutUs')}}"
                            >AboutUs</a>
                            <a class="collapse-item" href="{{url('Admin/category')}}"
                            >Catgeory</a>
                            <a class="collapse-item" href="{{url('Admin/social')}}"
                            >Social</a>
                            <a class="collapse-item" href="{{url('Admin/slug')}}"
                            >Slug</a>
                        </div>
                    </div>
                </li>
